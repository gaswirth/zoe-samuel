...
function rhd_enqueue_styles(){
	...
	wp_register_style( 'google-fonts', '//fonts.googleapis.com/css?family=Waiting+for+the+Sunrise|Cutive+Mono|PT+Serif' );
...
function rhd_add_editor_styles() {
	...
	$font_url = '//fonts.googleapis.com/css?family=Lato:400,400italic,700|Rock+Salt|PT+Serif';
